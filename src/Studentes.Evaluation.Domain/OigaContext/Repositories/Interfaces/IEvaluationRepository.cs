...
namespace Studentes.Evaluation.Domain.OigaContext.Repositories.Interfaces
{
    ...
    {
        public Task<PagedResult<Studentes.Evaluation.Domain.OigaContext.Entities.Evaluation>> GetAllEvaluationsPaged(int pageSize, int pageIndex, string query = null);
    }
}
